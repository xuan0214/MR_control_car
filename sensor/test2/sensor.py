...
def on_message(client, userdata, msg):
    ...
    if msg.payload.decode('utf-8') == 'forward' :
        ...
        speed = abs(x_speed) * 9.80665 * delta_time * 100
        ...
        delta_time = end_time - start_time
        #print('time1 = ' + str(end_time))
        num = abs(x_speed) * abs(x_speed) + abs(y_speed) * abs(y_speed) + abs(z_speed) * abs(z_speed)
        speed = pow(num, 1/3) * 9.80665 * delta_time * 100
        print('speed = ' + str(speed))
        client.publish('speed', json.dumps(speed))
        #print('xspeed = ' + str(x_speed))
        #print('yspeed = ' + str(y_speed))
